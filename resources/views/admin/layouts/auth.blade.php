...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/backend/css/vendor.min.css') }}">
    ...
    <style>
        ...
        .background-view {
            background-image: url('https://source.unsplash.com/random/1920x1280/?park,travel,sunset'), url('assets/backend/image/river.jpeg');
                ...
                <div class="d-flex flex-column justify-content-between align-items-center py-5 px-4 min-vh-100">
                    ...
                    <a href="" class="d-block">
                        <div class="system-logo d-flex justify-content-center">
                            <img src="{{ config('setting.logos.dark')  }}" alt="{{ __('logo') }}" class="img-fluid">
                        </div>
                    </a>
